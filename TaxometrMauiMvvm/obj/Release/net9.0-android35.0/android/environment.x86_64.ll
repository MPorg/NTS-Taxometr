...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 1053, ; uint32_t number_of_aot_cache_entries
	i32 125, ; uint32_t number_of_shared_libraries
	i32 u0x020002f3, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06001c1e, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001c1d, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [1053 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 u0x003beba4753b78eb, ; from name: libaot-System.Net.NameResolution
		i64 u0x7f280e9be5453eba, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.88_name, ; name: libaot-System.Net.NameResolution.dll.so
		ptr null; void* handle
	}, ; 0
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.99_name, ; name: libaot-System.Reflection.Primitives.dll.so
		ptr null; void* handle
	}, ; 39
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.37_name, ; name: libaot-Xamarin.AndroidX.Browser.dll.so
		ptr null; void* handle
	}, ; 65
	%struct.DSOCacheEntry {
		i64 u0x0e6871494c5d2bf5, ; from name: TaxometrMauiMvvm.so
		i64 u0x6d4a436e474ed13b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TaxometrMauiMvvm.dll.so
		ptr null; void* handle
	}, ; 66
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.28_name, ; name: libaot-Plugin.BLE.dll.so
		ptr null; void* handle
	}, ; 86
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x1490cc19416db30c, ; from name: libaot-TaxometrMauiMvvm.so
		i64 u0x6d4a436e474ed13b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TaxometrMauiMvvm.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x1fb3fa4068a5a9cb, ; from name: TaxometrMauiMvvm
		i64 u0x6d4a436e474ed13b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TaxometrMauiMvvm.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.97_name, ; name: libaot-System.Reflection.Emit.ILGeneration.dll.so
		ptr null; void* handle
	}, ; 137
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.98_name, ; name: libaot-System.Reflection.Emit.Lightweight.dll.so
		ptr null; void* handle
	}, ; 138
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x51b56f19c7f5c386, ; from name: aot-TaxometrMauiMvvm.so
		i64 u0x6d4a436e474ed13b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TaxometrMauiMvvm.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5d3319d0c6ac50c2, ; from name: aot-TaxometrMauiMvvm
		i64 u0x6d4a436e474ed13b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TaxometrMauiMvvm.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x65e71352b045be71, ; from name: aot-Honoo.IO.Hashing.Crc.so
		i64 u0x8d5b050001701dfb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Honoo.IO.Hashing.Crc.dll.so
		ptr null; void* handle
	}, ; 397
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x6d4a436e474ed13b, ; from name: libaot-TaxometrMauiMvvm.dll.so
		i64 u0x6d4a436e474ed13b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TaxometrMauiMvvm.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7b2a8e1d983a6a09, ; from name: libaot-Honoo.IO.Hashing.Crc.so
		i64 u0x8d5b050001701dfb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Honoo.IO.Hashing.Crc.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8ced356686e20d65, ; from name: aot-TaxometrMauiMvvm.dll.so
		i64 u0x6d4a436e474ed13b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TaxometrMauiMvvm.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8d5b050001701dfb, ; from name: libaot-Honoo.IO.Hashing.Crc.dll.so
		i64 u0x8d5b050001701dfb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Honoo.IO.Hashing.Crc.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa4dc3ad7c89ae71c, ; from name: libaot-Honoo.IO.Hashing.Crc
		i64 u0x8d5b050001701dfb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Honoo.IO.Hashing.Crc.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xac164c76fb2a0302, ; from name: TaxometrMauiMvvm.dll.so
		i64 u0x6d4a436e474ed13b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TaxometrMauiMvvm.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xbf021e17a9ba30ba, ; from name: libaot-TaxometrMauiMvvm
		i64 u0x6d4a436e474ed13b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TaxometrMauiMvvm.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc5f478d4a7f882a1, ; from name: Honoo.IO.Hashing.Crc.so
		i64 u0x8d5b050001701dfb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Honoo.IO.Hashing.Crc.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc87526a065d3d86f, ; from name: aot-Honoo.IO.Hashing.Crc.dll.so
		i64 u0x8d5b050001701dfb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Honoo.IO.Hashing.Crc.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xde8db6c240bbe04e, ; from name: Honoo.IO.Hashing.Crc.dll.so
		i64 u0x8d5b050001701dfb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Honoo.IO.Hashing.Crc.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe8fdb82dcf250012, ; from name: Honoo.IO.Hashing.Crc
		i64 u0x8d5b050001701dfb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Honoo.IO.Hashing.Crc.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf1e009f7ec73bed2, ; from name: aot-Honoo.IO.Hashing.Crc
		i64 u0x8d5b050001701dfb, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Honoo.IO.Hashing.Crc.dll.so
		ptr null; void* handle
...
@dso_apk_entries = dso_local local_unnamed_addr global [125 x %struct.DSOApkEntry] zeroinitializer, align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [17 x i8] c"com.nts.taxometr\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [31 x i8] c"libaot-TaxometrMauiMvvm.dll.so\00", align 16
...
@.DSOCacheEntry.13_name = private unnamed_addr constant [35 x i8] c"libaot-Honoo.IO.Hashing.Crc.dll.so\00", align 16
...
@.DSOCacheEntry.28_name = private unnamed_addr constant [25 x i8] c"libaot-Plugin.BLE.dll.so\00", align 16
...
@.DSOCacheEntry.37_name = private unnamed_addr constant [39 x i8] c"libaot-Xamarin.AndroidX.Browser.dll.so\00", align 16
...
@.DSOCacheEntry.88_name = private unnamed_addr constant [40 x i8] c"libaot-System.Net.NameResolution.dll.so\00", align 16
...
@.DSOCacheEntry.97_name = private unnamed_addr constant [50 x i8] c"libaot-System.Reflection.Emit.ILGeneration.dll.so\00", align 16
@.DSOCacheEntry.98_name = private unnamed_addr constant [49 x i8] c"libaot-System.Reflection.Emit.Lightweight.dll.so\00", align 16
@.DSOCacheEntry.99_name = private unnamed_addr constant [43 x i8] c"libaot-System.Reflection.Primitives.dll.so\00", align 16
