...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001bf9, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001bf8, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [900 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.56_name, ; name: libaot-Xamarin.AndroidX.VersionedParcelable.dll.so
		ptr null; void* handle
	}, ; 62
	%struct.DSOCacheEntry {
...
@.DSOCacheEntry.56_name = private unnamed_addr constant [51 x i8] c"libaot-Xamarin.AndroidX.VersionedParcelable.dll.so\00", align 16
