...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001c1c, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001c1b, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [909 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.95_name, ; name: libaot-System.Text.Encoding.CodePages.dll.so
		ptr null; void* handle
	}, ; 66
	%struct.DSOCacheEntry {
...
@.DSOCacheEntry.95_name = private unnamed_addr constant [45 x i8] c"libaot-System.Text.Encoding.CodePages.dll.so\00", align 16
