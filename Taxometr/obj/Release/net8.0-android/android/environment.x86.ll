...
@dso_cache = dso_local local_unnamed_addr global [616 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 402111655, ; hash 0x17f7bca7, from name: libaot-MvvmCross
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 851917507, ; hash 0x32c73ac3, from name: aot-Taxometr
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 937051118, ; hash 0x37da43ee, from name: libaot-MvvmCross.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-MvvmCross.dll.so
		ptr null; void* handle (0x0)
	}, ; 121
	...
	%struct.DSOCacheEntry {
		i64 1242429695, ; hash 0x4a0df8ff, from name: aot-MvvmCross
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-MvvmCross.dll.so
		ptr null; void* handle (0x0)
	}, ; 158
	...
	%struct.DSOCacheEntry {
		i64 2086466062, ; hash 0x7c5cf20e, from name: MvvmCross.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-MvvmCross.dll.so
		ptr null; void* handle (0x0)
	}, ; 286
	...
	%struct.DSOCacheEntry {
		i64 2350806097, ; hash 0x8c1e7451, from name: libaot-Taxometr
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Taxometr.dll.so
		ptr null; void* handle (0x0)
	}, ; 326
	...
	%struct.DSOCacheEntry {
		i64 2502127081, ; hash 0x95236de9, from name: aot-Taxometr.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Taxometr.dll.so
		ptr null; void* handle (0x0)
	}, ; 351
	...
	%struct.DSOCacheEntry {
		i64 2841509791, ; hash 0xa95dff9f, from name: Taxometr.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Taxometr.dll.so
		ptr null; void* handle (0x0)
	}, ; 403
	...
	%struct.DSOCacheEntry {
		i64 2935930283, ; hash 0xaefebdab, from name: aot-MvvmCross.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-MvvmCross.dll.so
		ptr null; void* handle (0x0)
	}, ; 417
	...
	%struct.DSOCacheEntry {
		i64 3588643550, ; hash 0xd5e65ade, from name: libaot-Taxometr.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Taxometr.dll.so
		ptr null; void* handle (0x0)
	}, ; 510
	...
	%struct.DSOCacheEntry {
		i64 3624345935, ; hash 0xd807214f, from name: MvvmCross
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-MvvmCross.dll.so
		ptr null; void* handle (0x0)
	}, ; 517
	...
	%struct.DSOCacheEntry {
		i64 3874194283, ; hash 0xe6eb836b, from name: Taxometr
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Taxometr.dll.so
		ptr null; void* handle (0x0)
	}, ; 551
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [132 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
